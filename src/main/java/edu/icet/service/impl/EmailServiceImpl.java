...
public class EmailServiceImpl implements EmailService {
    ...
    public void sendSimpleMessage(String to, String subject, String text) {
        ...
        try {
            ...
            message.setFrom("noreply@internship-portal.com");
            message.setTo(to);
    ...
    public void sendApplicationNotification(String to, String studentName, String internshipTitle) {
        ...
        String text = String.format(
                "Dear Recruiter,\n\n" +
                        "You have received a new application from %s for the internship position: %s.\n\n" +
    ...
    public void sendStatusUpdateNotification(String to, String internshipTitle, String status) {
        ...
        String text = String.format(
                "Dear Student,\n\n" +
                        "Your application for the internship position \"%s\" has been updated.\n\n" +
                        "Current Status: %s\n\n" +
